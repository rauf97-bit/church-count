          ...
          <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            <div className="mx-auto sm:mt-3 w-11/12 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-4 md:mb-0">
              <form onSubmit={handleSubmit}>
                ...
                <p className="text-[24px] text-firstBlue text-center font-semibold mt-0 mb-2 sm:mb-6">
                  Sign up
                </p>
                <div className="mb-[6px]">
                  <label className="text-[14px] text-primaryTextColor">
                    First Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  ...
                  <p className="text-base mb-5 md:mb-0 text-tertiaryTextColor">
                    ...
                    <Link to={"/"} className="underline text-primaryTextColor">
                      {" "}
                      Sign in
                    </Link>
                  </p>
